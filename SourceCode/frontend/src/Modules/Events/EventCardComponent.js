...
import { formateDateDayAndDate } from '../../Utils/DateFormat';
    ...
    <div className="col-lg-4 col-xl-4">
      <div className="day-view-item">
        <div className="day-view-item-header">
          <div className="day-view-header-title">{agancyName}</div>
        ...
        <div className="day-view-item-details">
          ...
          <div className="timings d-flex justify-content-between">
            <div className="date-wrapper">{formateDateDayAndDate(date)}</div>
