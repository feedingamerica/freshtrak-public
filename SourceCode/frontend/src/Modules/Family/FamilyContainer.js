    ...
    const handleSubmit = () => {
        let familyDetails = {
            familyMemberData: {
                ...
                phoneNumber: familyData.nameData ? familyData.nameData.nameData.phoneNumber : '',
                phoneNumberCheckBOx: familyData.nameData ? familyData.nameData.nameData.phoneNumberCheckBOx : '',
                email: familyData.nameData ? familyData.nameData.nameData.email : '',
                communicationPreference: familyData.nameData ? familyData.nameData.nameData.communicationPreference : '',
            },
