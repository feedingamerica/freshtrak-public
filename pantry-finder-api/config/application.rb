...
Jets.application.configure do
  ...
  #   'https://cloudfront.domain.com/assets' # example
  ...
  #   "arn:aws:iam::#{Jets.aws.account}:role/service-role/pre-created"
  # config.function.memory_size = 1536

  # config.api.endpoint_type = 'PRIVATE'
  # Default is 'EDGE'
  # (https://docs.aws.amazon.com/apigateway/api-reference/
  #   link-relation/restapi-create/#endpointConfiguration)
  ...
  # }
  # The config.function settings to the CloudFormation
  #   Lambda Function properties.
  # http://docs.aws.amazon.com/AWSCloudFormation/latest/
  #   UserGuide/aws-resource-lambda-function.html
  # Underscored format can be used for keys to
  # make it look more ruby-ish.

  # Assets settings
  # The config.assets.folders are folders within
  # the public folder that will be set
  # to public-read on s3 and served directly.
  # IE: public/assets public/images public/packs
  ...
  # IE: "public, max-age=3600"
  # override max_age for more fine-grain control.
  ...
  # "arn:aws:acm:us-west-2:112233445566:certificate/
  #   8d8919ce-a710-4050-976b-b33da991e123"
  # us-east-1 EDGE endpoint - takes 10-15 minutes
  # config.domain.cert_arn =
  # "arn:aws:acm:us-east-1:112233445566:certificate/
  #   d68472ba-04f8-45ba-b9db-14f839d57123"
  # config.domain.endpoint_type = "EDGE"

  # By default logger needs to log to $stderr for
  # CloudWatch to receive Lambda messages, but for
  # local testing environment you may want to log these
  # messages to 'test.log' file to keep your
